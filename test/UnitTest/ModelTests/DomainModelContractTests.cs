...
public class DomainModelContractTests
{
    ...
    public static IEnumerable<object[]> InstanceProductionUpdateCases()
    {
        ...
        yield return [new[] { "Status", "Substatus" }, """{"Status":{"Substatus":{}}}"""];
        yield return
        [
        ...
        yield return [new[] { "CompleteConfirmations" }, """{"CompleteConfirmations":[{}]}"""];
        yield return
        [
        ...
        yield return [new[] { "Created" }, """{"Created":"2024-01-02T03:04:05Z"}"""];
        yield return [new[] { "DueBefore" }, """{"DueBefore":"2024-04-05T06:07:08Z"}"""];
        yield return [new[] { "VisibleAfter" }, """{"VisibleAfter":"2024-04-01T02:03:04Z"}"""];
    }
    ...
    public static IEnumerable<object[]> DataElementProductionUpdateCases()
    {
        yield return [new[] { "Locked" }, """{"Locked":true}"""];
        yield return [new[] { "Refs" }, """{"Refs":["99999999-8888-4777-8666-555555555555"]}"""];
        yield return [new[] { "References" }, """{"References":[{}]}"""];
        yield return [new[] { "Tags" }, """{"Tags":["contract","golden"]}"""];
        yield return
        [
        ...
        yield return [new[] { "DeleteStatus" }, """{"DeleteStatus":{}}"""];
        yield return [new[] { "LastChanged" }, """{"LastChanged":"2024-01-03T04:05:06Z"}"""];
        yield return [new[] { "LastChangedBy" }, """{"LastChangedBy":"last-changed-by"}"""];
        yield return [new[] { "FileScanResult" }, """{"FileScanResult":"Clean"}"""];
        yield return [new[] { "ContentType" }, """{"ContentType":"application/pdf"}"""];
        yield return [new[] { "Filename" }, """{"Filename":"contract.pdf"}"""];
        yield return [new[] { "Size" }, """{"Size":12345}"""];
        yield return
        [
            new[] { "BlobStoragePath" },
            """{"BlobStoragePath":"org/app/instance/data/element"}""",
        ];
        yield return [new[] { "IsRead" }, """{"IsRead":false}"""];
    }
