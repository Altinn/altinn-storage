...
public sealed class InstanceInternal
{
    ...
    /// </summary>
    /// <remarks>
    /// This remains a string because existing rows and caller-supplied ids may retain GUID casing,
    /// while the archive-reference query uses a case-sensitive text suffix match.
    /// </remarks>
