...
public sealed class DataElementInternal
{
    ...
    /// </summary>
    /// <remarks>
    /// Kept as text so legacy JSON can be materialized without normalization. Persistence operations
    /// parse the value when passing it to the UUID-typed <c>alternateid</c> column.
    /// </remarks>
    ...
    /// <remarks>
    /// Kept as text so legacy JSON can be materialized without normalization. Persistence operations
    /// parse the value when passing it to the UUID-typed <c>instanceguid</c> column.
    /// </remarks>
