    ...
    public class InstancesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Instance>> Post(string appId, [FromBody] Instance instance, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Created instance: {storedInstance.Id}", storedInstance.Id.Replace(Environment.NewLine, string.Empty));
            ...
            {
                _logger.LogError(storageException, "Unable to create {appId} instance for {instance.InstanceOwner.PartyId}", appId.Replace(Environment.NewLine, string.Empty), instance.InstanceOwner.PartyId);
                ...
                _logger.LogError("Deleted instance {storedInstance.Id}", storedInstance?.Id.Replace(Environment.NewLine, string.Empty));
