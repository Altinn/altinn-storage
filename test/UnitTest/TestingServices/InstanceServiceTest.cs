...
namespace Altinn.Platform.Storage.UnitTest.TestingServices
{
    public class InstanceServiceTest
    {
        ...
        public async Task CreateSignDocument_SigningSuccessful_SignedEventDispatched()
        {
            ...
            {
                InstanceOwner = new(),
                Process = new ProcessState { CurrentTask = new ProcessElementInfo { ElementId = "CurrentTask" } }
            });
        ...
        public async Task CreateSignDocument_SigningFailed_InstanceNotExists()
        {
            // Arrange
            var instanceRepositoryMock = new Mock<IInstanceRepository>();
            instanceRepositoryMock.Setup(rm => rm.GetOne(It.IsAny<int>(), It.IsAny<Guid>())).ReturnsAsync((Instance)null);
