...
public class ProcessController : ControllerBase
{
    ...
    )
    {
        ...
        // When the instance is entering a task, remove any data elements that were
        // generated by previous visits to that same task (e.g. stale PDFs, signatures).
        // Best-effort: individual failures are logged inside the service and do not
        // block the process advance. Skipped on terminal transitions where there is
        // no current task.
