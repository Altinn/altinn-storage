...
namespace Altinn.Platform.Storage.Repository
{
    ...
    public interface IBlobRepository
    {
        ...
        Task<(long ContentLength, DateTimeOffset LastModified)> WriteBlob(string org, Stream stream, string blobStoragePath, int? alternateContainerNumber);
        ...
        Task<Stream> ReadBlob(string org, string blobStoragePath, int? alternateContainerNumber);
        ...
        Task<bool> DeleteBlob(string org, string blobStoragePath, int? alternateContainerNumber);
        ...
        /// <param name="alternateContainerNumber">Alternate number to append to container name</param>
        /// <returns>A value indicating whether the delete was successful.</returns>/// 
        Task<bool> DeleteDataBlobs(Instance instance, int? alternateContainerNumber);
    }
}
