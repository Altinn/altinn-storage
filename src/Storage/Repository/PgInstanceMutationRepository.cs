...
) : IInstanceMutationRepository
{
    ...
    internal static string BuildCreateElementsPayload(
    ...
    internal static string BuildUpdateElementsPayload(
    ...
    internal static string BuildDeleteElementsPayload(
    ...
    internal static string BuildInstanceUpdatesPayload(InstanceMutationCommit mutation)
    {
