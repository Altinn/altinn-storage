...
public static class PrincipalUtil
{
    ...
    )
    {
        ...
        {
            claims.Add(
                new Claim("scope", string.Join(" ", claimScopes), ClaimValueTypes.String, issuer)
            );
        }
    ...
    public static string GetOrgToken(
        string org,
        int orgNumber = 111111111,
        string scope = "altinn:appdeploy"
    )
    {
        List<Claim> claims = new List<Claim>();
        string issuer = "UnitTest";
