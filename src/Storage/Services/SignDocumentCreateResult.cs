...
public sealed record SignDocumentCreateResult
{
    ...
    /// <summary>
    /// Creates a precondition-failed signing result with current versions.
    /// </summary>
    public static SignDocumentCreateResult PreconditionFailed(
        ServiceError serviceError,
        StorageVersions versions
    ...
    /// <summary>
    /// Supports call sites that only need created/error.
    /// </summary>
