...
public class ProcessController : ControllerBase
{
    ...
    )
    {
        ...
        // Best-effort: individual failures are logged inside the service and do not block the process advance.
        // Skipped on terminal transitions where there is no current task.
