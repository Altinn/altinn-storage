...
namespace Altinn.Platform.Storage.Services
{
    ...
    public class InstanceService : IInstanceService
    {
        ...
        public async Task<(bool Created, ServiceError ServiceError)> CreateSignDocument(int instanceOwnerPartyId, Guid instanceGuid, SignRequest signRequest, int userId)
        {
            ...
            {
                (string base64Sha256Hash, serviceError) = await _dataService.GenerateSha256Hash(instance.Org, instanceGuid, Guid.Parse(dataElementSignature.DataElementId), app.AlternateContainerNumber);
            ...
            {
                await _dataService.UploadDataAndCreateDataElement(instance.Org, fileStream, dataElement, instanceInternalId, app.AlternateContainerNumber);
            }
